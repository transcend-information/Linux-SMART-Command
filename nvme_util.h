...
public:
    ...
    struct nvme_badblock {
        char  badblock[1];

    };
    struct nvme_WAI_Info {
        unsigned char wai[4096];
    ...
    bool nvme_read_badblock( void * data, unsigned size);
	bool nvme_read_WAI( void * data, unsigned size);
